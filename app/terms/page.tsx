...
export const metadata: Metadata = {
  title: 'Terms & Conditions - Soul Paradise Travels',
  description: 'Read the Terms and Conditions for using Soul Paradise Travels website and services. Governed by the laws of India.',
};
...
const sections = [
  ...
  },
  {
    ...
    content: [
      'Questions about the Terms of Service should be sent to us at soulparadise21@gmail.com.',
    ],
  },
];
  ...
  return (
    <main className="min-h-screen bg-(--color-background)">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-12 md:pt-28 md:pb-16">
        ...
        <p className="text-(--color-inactive) leading-relaxed text-base max-w-3xl">
      ...
      <section className="bg-(--color-peace) py-12 md:py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-(--color-background) p-6 sm:p-8 rounded-lg shadow-md">
            <h2 className="text-2xl font-bold text-(--color-foreground) mb-4">Overview</h2>
            <div className="space-y-4 text-(--color-inactive) leading-relaxed text-base">
              <p>
                This website is operated by Soul Paradise. Throughout the site, the terms &quot;we&quot;, &quot;us&quot; and &quot;our&quot; refer to Soul Paradise. Soul Paradise offers this website, including all information, tools and services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.
              </p>
              <p>
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        <div className="space-y-10">
          {sections.map((section, index) => (
            <div key={index}>
              <h2 className="text-xl sm:text-2xl font-bold text-(--color-foreground) mb-4">
                {section.title}
              </h2>
              <div className="space-y-3 text-(--color-inactive) leading-relaxed text-base">
      ...
      <section className="bg-(--color-peace) py-12 md:py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-2xl sm:text-3xl font-bold text-(--color-foreground) mb-4">
            Have Questions?
          </h2>
          <p className="text-(--color-inactive) mb-6 max-w-2xl mx-auto">
            If you have any questions about our Terms of Service, feel free to reach out to us. We&apos;re here to help.
          </p>
          <Link
            href="/contact"
            className="inline-block px-6 py-3 bg-(--color-primary-button) text-(--color-peace) rounded-lg font-semibold hover:bg-(--color-secondary-button) transition-colors"
          >
            Contact Us
          </Link>
        </div>
